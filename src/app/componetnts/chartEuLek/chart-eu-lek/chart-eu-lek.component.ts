...
@Component({
  selector: 'app-chart-eu-lek',
  templateUrl: './chart-eu-lek.component.html',
  styleUrls: ['./chart-eu-lek.component.css']
})

export class ChartEuLekComponent implements OnInit {
  chart: Chart;

  private value = [];
  private serviceUrl = 'https://ourcurrency.herokuapp.com/getdata?currency=EUR&second_currency=LEK';
  private getLastUrl = 'https://ourcurrency.herokuapp.com/getlast?first_currency=EUR&second_currency=LEK';
  mydata = Array<any>();
   myLabel = Array<any>();
